  ...
  return (
    <section className={classes.root}>
      <Typography variant='h1' className={classes.title}>
        How users feel about Ocean Blue
      </Typography>
      <AliceCarousel
        mouseDragEnabled
        autoPlay
...
const USERS = [
  {
    name: 'Lux Expression®',
    subName: '@Lux',
    description: 'A big shout-out to the @Ocean Blue team. Designing a platform like this is no easy task, but they have done an incredible job & continue to be the best in the NFT Space. 🏆',
  ...
  },
  {
    name: 'Lux Expression®',
    subName: '@Lux',
    description: 'Ocean Blue is where it’s at',
  ...
  },
  {
    name: 'Lux Expression®',
    subName: '@Lux',
    description: 'I’m so interested in using your platform in 2020, I’m loving the UX and ease of use of Ocean Blue, keep it up',
  ...
  },
  {
    name: 'Lux Expression®',
    subName: '@Lux',
    description: 'Yes, it is true that @Ocean Blue is innovating heavily in the space. Check them out!',
